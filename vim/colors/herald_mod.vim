...
elseif &t_Co == 256
	...
	hi CursorColumn   ctermbg=1                  cterm=none
	hi CursorLine     ctermbg=103  ctermfg=0     cterm=none
	...
	" -> Search 
	hi Search         ctermbg=1    ctermfg=255   cterm=none 
	...
	"
	" -> Visual Mode
	hi Visual         ctermbg=25   ctermfg=255   cterm=none 
